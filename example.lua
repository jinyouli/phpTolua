...
local LibStub = Tinkr.Util.LibStub
-- local sha = Tinkr:require('sha2')
...
function StringToHex(str)
    ...
    for i = 1, Strlen do
        ...
        Hex = string.format("%02x",temp) .. Hex
    end
    return Hex
end
...
challenge = '';
restore_uri = 'https://www.battlenet.com.cn/enrollment/initiatePaperRestore.htm';
restore_validate_uri = 'https://www.battlenet.com.cn/enrollment/validatePaperRestore.htm';


HTTP:POST(restore_uri, "CN210817232724", {
...
function(status, body)
    ...
    if status == 200 then
        ...
        orgin = 'CN-2108-1825-8015'
        serial = string.gsub(orgin, "-", "")
        challenge = body

        local restore = 'JQKNUMRWG5'
        ...
        HTTP:POST('https://www.battlenet.com.cn/enrollment/validatePaperRestore.htm', 'CN210817232724', {
            "Content-Type: application/octet-stream",
            "Connection: close"
        },
        function(status, body)
